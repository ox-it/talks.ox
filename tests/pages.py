...
datetimepicker = Element('//div[contains(@class,"datepicker")]')
datetimepicker_current_day = Element('//*[@class="datepicker-days"]//*[contains(@class, "active")]')
datetimepicker_current_hour = Element('//*[@class="timepicker-hours"]//*[contains(@class, "active")]')
datetimepicker_current_minute = Element('//*[@class="timepicker-minutes"]//*[contains(@class, "active")]')
