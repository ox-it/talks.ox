...
class EventForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if self.cleaned_data['booking_url'] and self.cleaned_data['booking_email']:
            raise forms.ValidationError("Please provide only one of Booking web address and Booking email")
